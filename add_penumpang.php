...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <form action="<?= base_url('Home/aksi_add_penumpang') ?>" method="post">
                ...
                <div class="mb-3 text-white">
                    ...
                    <input type="text" class="form-control" id="nama" placeholder="Enter your nickname" name="nama">
                ...
                <div class="mb-3 text-white">
                    ...
                    <input type="date" class="form-control" id="tl" placeholder="Enter your birth date" name="tl">
